# RF.AutoPopulatePlaylists
 A Rhythm Festival mod to automatically populate specified filter lists based on specified criteria.\
 When you first install the mod, a default json file will be generated in BepInEx/data/AutoPopulatePlaylists.\
 Use this default file to create your filters however you like. 
